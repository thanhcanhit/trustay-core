...
export class BillResponseDto {
	...
	@Transform(({ obj }) =>
		obj.billItems?.map((item: any) => ({
			...
			quantity: item.quantity != null ? convertDecimalToNumber(item.quantity) : undefined,
			unitPrice: item.unitPrice != null ? convertDecimalToNumber(item.unitPrice) : undefined,
